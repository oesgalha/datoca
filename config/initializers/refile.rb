...
Refile.configure do |config|
  config.allow_origin = Copas.defaults.base_url
...
def acceptance_url(file)
  Copas::Application.routes.url_helpers.new_competition_acceptance_url(competition, host: Copas.defaults.base_url)
end
